...
public class ModificarUser extends JFrame implements ActionListener {
    ...
    public ModificarUser() {
        super("Administracion de Usuario");
        usuario = new JLabel();
        nombre = new JLabel();
        apellido = new JLabel();
        id = new JLabel();
    ...
    public void modificar() {
        try {
            for (int i = 0; i < 10; i++) {
                if (numero == AgregarUser.vectoruser[i].getId()) {
                    AgregarUser.vectoruser[i].setPass(txtcontra.getText());
                    AgregarUser.vectoruser[i].setApellido(txtapet.getText());
                    AgregarUser.vectoruser[i].setUsuario(txtusuario.getText());
                    AgregarUser.vectoruser[i].setNombre(txtnombre.getText());
